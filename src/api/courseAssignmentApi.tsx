...
export const createCourseAssignmentApi = async ( newCourseAssignment:any) => {
    try {
        const response = await apiClient.post('/courseAssignment', newCourseAssignment);
...
export const updateCourseAssignmentApi = async (id:number, updateAssignment:any) => {
    try {
        const response = await apiClient.put(`/courseAssignment/${id}`, updateAssignment);
