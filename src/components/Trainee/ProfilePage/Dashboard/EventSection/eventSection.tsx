...
//   if (loading) {
//     return (
//       <div className="text-center py-4 text-gray-700">Loading events...</div>
//     );
//   }
...
//           {/* Table Header */}
//           <div className="grid grid-cols-6 gap-2 p-4 border-b bg-gray-100 sticky top-0">
//             <div className="font-semibold text-gray-700">Module Name</div>
//             <div className="font-semibold text-gray-700">Class Name</div>
...
//               <div
//                 key={event.id}
//                 className="grid grid-cols-6 gap-2 p-4 border-b hover:bg-gray-50"
//               >
//                 <div className="text-gray-800">{event.moduleName}</div>
//                 <div className="text-gray-800">{event.className}</div>
...
//                 </div>
//                 <div
//                   className={`font-semibold ${event.attendanceStatus === "Present" ? "text-green-600" : "text-red-500"}`}
//                 >
