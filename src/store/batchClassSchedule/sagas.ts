...
export function* fetchBatchClassSchedulesSaga(): Generator<any, void, any> {
  try {
    ...
    console.log("Fetched Batch Class Schedules:", response);
...
export function* fetchBatchClassScheduleByIdSaga(action: {
    ...
    try {
      ...
      console.log("Fetched Batch Class Schedule by ID:", response);
...
export function* fetchBatchClassScheduleByBatchIdSaga(action: {
  ...
  try {
    ...
    console.log("Fetched Batch Class Schedule by Batch ID:", response);
    yield put({
